...
%token TITLE AUTHORS DATE DEFAULT LANGUAGE UPDATED TAGS SUMMARY
...
value_list:
  ...
  | vl = value_list ; TAGS ; COLON ; tags = ne_qstring_list
    { Article_ast.Tags tags :: vl }
  | vl = value_list ; SUMMARY ; COLON ; s = QSTRING
    { Article_ast.Summary s :: vl }
  ;
